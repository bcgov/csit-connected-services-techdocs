...
### Working within current scope 

Roles and responsibilities continue to evolve alongside Connected Services implementation. 

To understand the current boundaries and phased rollout of capabilities, review [Limits and constraints](limits-and-constraints.md). 