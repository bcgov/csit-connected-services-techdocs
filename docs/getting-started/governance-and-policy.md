...
Review [Privacy and security](privacy-and-security.md) for information on technical enforcement mechanisms. 

## Who participates 

Governance depends on clearly defined roles across ministries and technical teams. 

To see how different actors contribute to publishing, accessing, and overseeing data, review [Roles and responsibilities](roles-and-responsibilities.md). 